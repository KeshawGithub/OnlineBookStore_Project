...
/* -----------------Footer CSS-------------------------- */
 .footer {
  ...
  #carouselExampleIndicators .carousel-item img {
      ...
      object-fit: fitr; /* Ensure images maintain aspect ratio and fill space */
  }
...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-touch="true" data-bs-interval="3000">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="imageEbook/BookHoarding_1.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="imageEbook/OldManWithBook.png" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="imageEbook/Books-and-cover.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="imageEbook/BookHoarding_3.jpg" class="d-block w-100" alt="...">
    </div>
  </div>
				...
				<div class="col-md-3">
					<div class="card mt-4 bookcontainer">
						<div class="card-body text-center cbody">
							...
							<a href="viewBook.jsp?bookId=<%=b.getBookId()%>" class="btn btn-success mt-2"><i
